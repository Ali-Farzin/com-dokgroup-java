...
public class AccountsPermits {
    @SequenceGenerator(name = "AccountsPermits_id_gen", sequenceName = "BranchTerminals_BranchTerminalID_seq", allocationSize = 1)
    @EmbeddedId
    private AccountsPermitsId id;
    ...
    public AccountsPermitsId getId() {
        return id;
    }

    public void setId(AccountsPermitsId id) {
        this.id = id;
    }
